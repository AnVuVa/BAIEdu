import { MessageSquare, ThumbsUp, Eye, Search, Filter, Award, Star, Clock, ChevronRight, UserCircle2, MessageCircle } from 'lucide-react';
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { motion } from 'motion/react';

export default function Community() {
  const [activeTab, setActiveTab] = useState('discover'); // discover, review, leaderboard
