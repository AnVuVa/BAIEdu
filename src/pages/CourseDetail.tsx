...
export default function CourseDetail() {
  ...
  const modules = [
    {
      title: 'Học phần 1: Nền tảng AI',
      lessons: [
        { title: 'AI là gì và không là gì?', duration: '15:00', type: 'video' },
        { title: 'Cơ chế hoạt động cơ bản', duration: '20:30', type: 'video' },
        { title: 'Case Study: Sự cố thiên kiến', duration: '10 EXP', type: 'case' },
      ]
    },
    {
      title: 'Học phần 2: La bàn Đạo đức Số',
      lessons: [
        { title: 'Bản quyền và Sở hữu trí tuệ', duration: '25:00', type: 'video' },
        { title: 'Thiên kiến và Sự công bằng', duration: '18:45', type: 'video' },
        { title: 'Bảo mật dữ liệu cá nhân', duration: '22:15', type: 'video' },
        { title: 'Case Study: Deepfake trong bầu cử', duration: '15 EXP', type: 'case' },
      ]
    },
    {
      title: 'Học phần 3: Sử dụng AI đúng mục đích',
      lessons: [
        { title: 'Ứng dụng AI trong nghiên cứu tài liệu', duration: '30:00', type: 'video' },
        { title: 'Brainstorm ý tưởng hiệu quả', duration: '25:00', type: 'video' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Nhập môn AI & Sự thật <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">(AI Demystification)</span></h1>
              <p className="text-lg text-slate-300 mb-8 max-w-2xl leading-relaxed">
                Xóa bỏ lầm tưởng về AI, hiểu cơ chế hoạt động cơ bản và cách AI tạo ra kết quả. Khóa học nền tảng giúp bạn tự tin bước vào kỷ nguyên Trí tuệ Nhân tạo mà không đánh mất tư duy phản biện.
              </p>
