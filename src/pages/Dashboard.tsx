              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                <div className="p-6 flex flex-col sm:flex-row gap-6 items-center">
                  <div className="w-full sm:w-48 aspect-video bg-slate-100 rounded-xl overflow-hidden shrink-0 relative group cursor-pointer">
                    <img src="https://picsum.photos/seed/ai-ethics/600/400" alt="Course" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" referrerPolicy="no-referrer" />
                  ...
                  <div className="flex-1 w-full">
                    ...
                    <h3 className="text-lg font-bold text-slate-900 mb-2">Cơ chế hoạt động cơ bản của AI</h3>
