...
export default function Courses() {
  ...
  const courses = [
    {
      id: 1,
      title: 'Nhập môn AI & Sự thật',
      description: 'Xóa bỏ lầm tưởng về AI, hiểu cơ chế hoạt động cơ bản và cách AI tạo ra kết quả.',
      level: 'basic',
      domain: 'research',
      duration: '4 tuần',
    ...
    {
      id: 2,
      title: 'La bàn Đạo đức Số',
      description: 'Tìm hiểu về bản quyền, thiên kiến thuật toán và bảo mật dữ liệu cá nhân trong kỷ nguyên GenAI.',
      level: 'basic',
      domain: 'research',
      duration: '6 tuần',
      instructor: 'ThS. Trần Thị B',
      rating: 4.8,
      image: 'https://picsum.photos/seed/compass/600/400',
      badge: 'Mới'
    },
    {
      id: 3,
      title: 'AI trong Viết lách & Sáng tạo',
      description: 'Sử dụng AI để brainstorm, lập dàn ý và biên tập nội dung mà không đánh mất văn phong cá nhân.',
      level: 'advanced',
      domain: 'writing',
      duration: '5 tuần',
    ...
    },
    {
      ...
      description: 'Ứng dụng Midjourney và DALL-E trong thiết kế, hiểu rõ ranh giới bản quyền hình ảnh.',
      level: 'advanced',
      domain: 'design',
      duration: '8 tuần',
      instructor: 'Art Director Phạm D',
      rating: 4.9,
      image: 'https://picsum.photos/seed/design/600/400',
    },
    {
      id: 5,
      title: 'Nghiên cứu Khoa học & AI',
      description: 'Ứng dụng AI trong tổng hợp tài liệu, phân tích dữ liệu mà không vi phạm liêm chính học thuật.',
      level: 'advanced',
      domain: 'research',
      duration: '8 tuần',
              ...
              <div className="space-y-4 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
                ...
                <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white/10 border border-white/10 p-4 rounded-xl">
                    ...
                    <div className="font-bold text-white">Nhập môn AI & Sự thật</div>
                  </div>
                </div>
                {/* Step 2 */}
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white/5 border border-white/5 p-4 rounded-xl">
                    ...
                    <div className="font-bold text-slate-200">
                      {activeDomain === 'writing' ? 'AI trong Viết lách' : 
                       activeDomain === 'design' ? 'Thiết kế Đồ họa với AI' : 
                       activeDomain === 'programming' ? 'Code với AI Assistant' : 'Nghiên cứu Khoa học & AI'}
                    </div>
                  </div>
                </div>
              </div>
